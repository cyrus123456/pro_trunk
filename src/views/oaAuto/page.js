...
export default {
  ...
  created () {
    console.log('getToken', getToken('oaAuto-Token'))
    console.log('getToken', getToken('oaAuto-Token').fdid)
    console.log('this.$route.query', this.$route.params.code)
    querySystemPostTaskMenu({
